...
class MagicSquareGenerator
{
  generate(size)
  {
    ...
    let magicSquare = this.generateRandomSquare(size);

    while (!verifier.verify(splitter.split(magicSquare))) {
        magicSquare = this.generateRandomSquare(size);
    }

    return magicSquare;
  }
  
  generateRandomSquare(size) {
